/*
   ...
   (sent via serial interface, 115200 baud, using spaces between parameters.  Enter (<cr>, ASCII-code 0x0d) finishes a command)
    ...
    USB HID commands:
          ...
          AT JX <uint>      set joystick x axis (e.g. "AT JX 512" sets the x-axis to middle position)  
          AT JY <uint>      set joystick y axis (e.g. "AT JY 1023" sets the y-axis to full up position)  
          AT JZ <uint>      set joystick z axis (e.g. "AT JZ 0" sets the z-axis to lowest position)  
          AT JT <uint>      set joystick z turn axis (e.g. "AT JR 512" sets the rotation to middle position)  
          AT JS <uint>      set joystick slider position (e.g. "AT JS 512" sets the slider to middle position)  
          AT JP <uint>      press joystick button (e.g. "AT JP 1" presses joystick button 1)  
          AT JR <uint>      release joystick button (e.g. "AT JP 2" releases joystick button 2)  
